...
# Notes:
# This is an attempt to build a "master script" that will control multiple devices with minimal changes

# Enable / Disable debug text for FL Studio Script Output (True/False)
DEBUG = True

# Enable / Disable selftest mode
SELF_TEST = True

###
# Move all these mappings to an external JSON file(s)
...
# (I am sure there is a better way to reference these maps in forward and reverse.. Meh..) 
soundButtons = {
	0x51: "stop",
	0x5B: "play",
	0x5D: "record",
...
# We need to build out a state map somehow to track the state of each button.
class State():
	def __init__(self):
